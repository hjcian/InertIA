...
# source from: https://github.com/peliot/XIRR-and-XNPV
...
if __name__ == "__main__":
    ...
    # example ref.: http://www.masterhsiao.com.tw/ExcelFinance/IRR/IRR.htm
    cashflow = [
        (datetime.strptime('20070815', '%Y%m%d'), -100000),
        (datetime.strptime('20071106', '%Y%m%d'), 23650),
        (datetime.strptime('20080304', '%Y%m%d'), 25000),
        (datetime.strptime('20090608', '%Y%m%d'), 82500),
        ]
    print(xirr(cashflow)) # ~0.2455773