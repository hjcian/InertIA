...
class PopWarning(QMessageBox):
    ...
    #     self.buttonClicked.connect(self._msgbtn)
    # def _msgbtn(self):
    #     print("Button pressed is: {}".format(self.text()))
...
class AnnualizedReturnCalculator(QWidget):
    ...
    def setUI(self):
        ...
        self.vbox_layout.addWidget(self.ok)
        ...
        self.ok.clicked.connect(self._getUserInput)
